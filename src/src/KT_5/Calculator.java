...
public class Calculator {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Ошибка чтения файла History: " + e.getMessage());
        }
        while (true) {
            ...
            try {
                PrintWriter writer = new PrintWriter(new FileWriter("History"));
                for (Object equation : History) {
                    writer.println(equation);
                }
                writer.close();
            } catch (IOException e) {
                System.err.println("Ошибка записи в файл History: " + e.getMessage());
            }
        }
    }
}
